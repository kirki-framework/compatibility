...
class Aliases {
	...
	private $aliases = [
		'generic'    => [
			...
			[ 'Kirki\Modules\Webfonts\Module', 'Kirki_Modules_Webfonts' ],
			[ 'Kirki\Modules\Webfonts\Google', 'Kirki_Fonts_Google' ],
			[ 'Kirki\Modules\Webfonts\Fonts', 'Kirki_Fonts' ],
			[ 'Kirki\Modules\Webfonts\Embed', 'Kirki_Modules_Webfonts_Embed' ],
			[ 'Kirki\Modules\Webfonts\Async', 'Kirki_Modules_Webfonts_Async' ],
		...
		'customizer' => [
			...
			[ 'Kirki\Modules\Custom_Sections\Section_Default', 'Kirki_Sections_Default_Section' ],
			[ 'Kirki\Modules\Custom_Sections\Section_Expanded', 'Kirki_Sections_Expanded_Section' ],
			[ 'Kirki\Modules\Custom_Sections\Section_Nested', 'Kirki_Sections_Nested_Section' ],
			[ 'Kirki\Modules\Custom_Sections\Section_Link', 'Kirki_Sections_Link_Section' ],
			[ 'Kirki\Modules\Custom_Panels\Panel_Nested', 'Kirki_Panels_Nested_Panel' ],
		],
	];
